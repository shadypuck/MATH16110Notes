...
\begin{exercise}\label{exr:1.34}
    ...
    \begin{enumerate}[label={\alph*)},ref={\thetheorem\alph*}]
        ...
        \end{proof}
        \item \label{exr:1.34c}$|A\cup B|+|A\cap B|=|A|+|B|$.
        \begin{lemma*}
            ...
            \end{proof}
        \end{lemma*}
        \begin{proof}[Proof of Exercise \ref{exr:1.34c}]
            We want to show that $|A\cup B|+|A\cap B|=|A|+|B|$, which we can do by using the above lemma to justify various manipulations inspired by Exercise \ref{exr:1.34b}. To begin, use Lemma (a) as follows.
            \begin{align*}
                |A\cup B|+|A\cap B| &= |(B\setminus A)\cup A|+|A\cap B|
                \intertext{Since $(B\setminus A)\cup A$ is a union of two disjoint sets (see Lemma (b)), it follows by Exercise \ref{exr:1.34b} that the above}
            ...
            \end{align*}
        \end{proof}
        \item \label{exr:1.34d}\marginnote{10/13:}$|A\times B|=|A|\cdot|B|$.
        \begin{proof}
